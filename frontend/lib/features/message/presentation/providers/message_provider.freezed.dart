...
mixin _$MessageState {
  ...
  int get videoCallsCount => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      groupsCount: null == groupsCount
          ...
          : groupsCount // ignore: cast_nullable_to_non_nullable
              as int,
      videoCallsCount: null == videoCallsCount
          ? _value.videoCallsCount
          : videoCallsCount // ignore: cast_nullable_to_non_nullable
              as int,
      error: freezed == error
          ? _value.error
...
class _$MessageStateImpl implements _MessageState {
  ...
  final List<NotificationItem> _systemMessages;
  @override
  @JsonKey()
  List<NotificationItem> get systemMessages {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.videoCallsCount, videoCallsCount) ||
                other.videoCallsCount == videoCallsCount) &&
...
abstract class _MessageState implements MessageState {
  const factory _MessageState(
      ...
      final int groupsCount,
      final int videoCallsCount,
      final String? error}) = _$MessageStateImpl;
